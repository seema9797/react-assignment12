...
//initialize state
const initialState = {
    addMovies: localStorage.getItem("addMovies")?JSON.parse(localStorage.getItem("addMovies")):[],
    addSeats: localStorage.getItem("addSeats")?JSON.parse(localStorage.getItem("addSeats")):[]};
...
export const GlobalProvider = props => {
    ...
    const addSeatsMul = (seatNo) => {
        ...
        if (state.addSeats.some((element) => {
