  ...
  return (
    <SeatBook>
      <div>
            ...
            <rect x="29.5" y="12.5" width="41" height="41" fill="#DADADA" className="seat-default"  stroke="white" />
            <mask id="path-2-inside-1_324_138" fill="white">
                <path fillRule="evenodd" clipRule="evenodd" d="M28 26H6V71H94V26H72V55H28V26Z" />
            </mask>
            <path fillRule="evenodd" clipRule="evenodd" d="M28 26H6V71H94V26H72V55H28V26Z" fill="#DADADA" className='seat-default'/>
            <path
                ...
                fill="white"
                mask="url(#path-2-inside-1_324_138)"
            />
        </svg>
        </div>
    </SeatBook>
